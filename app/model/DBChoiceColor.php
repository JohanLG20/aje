...
class DBChoiceColor implements DBClass
{
    public static function getAllElements(): array
    {
        ...
        try {
            ...
            $query = $db->prepare("SELECT * FROM CHOICE_COLOR");
            $query->execute();
    ...
    public static function addNewElement(array $params): bool
    {
        ...
        try {
            $db = DBConnexion::getInstance()->getConnexion();
            $query = $db->prepare("INSERT INTO CHOICE_COLOR
            VALUES ()");
    ...
    public static function modifyElementById(array $params): bool
    {
        ...
        /* try {
            $db = DBConnexion::getInstance()->getConnexion();
            $query = $db->prepare("UPDDATE CHOICE_COLOR
            SET
            WHERE");
    ...
    public static function deleteElementById(int $id): bool
    {
        ...
        try {
            $db = DBConnexion::getInstance()->getConnexion();
            $query = $db->prepare("DELETE FROM CHOICE_COLOR
            WHERE id_choix = :id ");
    ...
    public static function getElementById(string $id): array|bool
    {
        try {
            $db = DBConnexion::getInstance()->getConnexion();
            $query = $db->prepare("SELECT * FROM CHOICE_COLOR WHERE id_choix = :id");
            $query->execute(
                [
                    ":id" => $id
                ]
